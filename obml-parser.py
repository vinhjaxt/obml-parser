...
for arg in sys.argv[1:]:
    with open("%s.html" % arg, "wb") as fout:
        ...
        for item in parse_file(arg):
            ...
            if type == "head":
                ...
                style = "; ".join(style)
                fout.write(('<div class="item body" style="%s"></div>' % style).encode('utf-8'))
            elif type == "text":
                ...
                style = "; ".join(style)
                fout.write(('<div class="item text" style="%s">' % style).encode('utf-8'))
